...
#         [7, 4] => [King, 'white'], [7, 5] => [Bishop, 'white'],
#         [7, 6] => [Knight, 'white'], [7, 7] => [Rook, 'white'],
#         [6, 0] => [Rook, 'white'], [6, 1] => [Rook, 'white'],
#         [6, 2] => [Rook, 'white'], [6, 3] =>  [Rook, 'white'],
#         [6, 4] => [Rook, 'white'], [6, 5] =>  [Rook, 'white'],
#         [6, 6] => [Rook, 'white'], [6, 7] =>  [Rook, 'white'],
#         [0, 0] => [Rook, 'black'], [0, 1] => [Knight, 'black'],
#         [0, 2] => [Bishop, 'black'], [0, 3] => [Queen, 'black'],
#         [0, 4] => [King, 'black'], [0, 5] => [Bishop, 'black'],
#         [0, 6] => [Knight, 'black'], [0, 7] => [Rook, 'black'],
#         [1, 0] => [Rook, 'black'], [1, 1] => [Rook, 'black'],
#         [1, 2] => [Rook, 'black'], [1, 3] => [Rook, 'black'],
#         [1, 4] => [Rook, 'black'], [1, 5] => [Rook, 'black'],
#         [1, 6] => [Rook, 'black'], [1, 7] => [Rook, 'black'] }.freeze
